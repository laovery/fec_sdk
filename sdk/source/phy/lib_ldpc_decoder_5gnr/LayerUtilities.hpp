...
// Dvec doesn't provide a Is16vec16FlexRAN class, which is an issue. Reported to the compiler team as issue
// CMPLRIL0-30948 in JIRA.
class Is16vec16FlexRAN
{
public:

  Is16vec16FlexRAN() = default;

  Is16vec16FlexRAN(int16_t v) : value(_mm256_set1_epi16(v)) { }
  Is16vec16FlexRAN(__m256i v) : value(v) { }

  operator __m256i() const { return value; }

  friend Is16vec16FlexRAN abs(Is16vec16FlexRAN v) { return _mm256_abs_epi16(v); }
  friend Is16vec16FlexRAN sat_add(Is16vec16FlexRAN lhs, Is16vec16FlexRAN rhs) { return _mm256_adds_epi16(lhs, rhs); }
  friend Is16vec16FlexRAN sat_sub(Is16vec16FlexRAN lhs, Is16vec16FlexRAN rhs) { return _mm256_subs_epi16(lhs, rhs); }
  friend Is16vec16FlexRAN sat_sub_unsigned(Is16vec16FlexRAN lhs, Is16vec16FlexRAN rhs) { return _mm256_subs_epu16(lhs, rhs); }

  Is16vec16FlexRAN operator>>(int count) const { return _mm256_srai_epi16(value, count); }

  __m256i value;
};

inline Is16vec16FlexRAN select_lt(Is16vec16FlexRAN a, Is16vec16FlexRAN b, Is16vec16FlexRAN c, Is16vec16FlexRAN d)
{
...
static Is16vec16FlexRAN ExpandMsb(int16_t msb)
{
...
template<> Is16vec16FlexRAN BroadcastInt16(int16_t v) { return _mm256_set1_epi16(v); }
...
static int32_t GetHorizontalSum(Is16vec16FlexRAN v)
{
  //16-->8
...
static int16_t GetNegativeMask(Is16vec16FlexRAN simd)
{
...
static Is16vec16FlexRAN ApplyParityCorrection(int16_t parity, Is16vec16FlexRAN value)
{
...
static void InsertSort(Is16vec16FlexRAN& min1, Is16vec16FlexRAN& min2, Is16vec16FlexRAN& minPos, int newPos, Is16vec16FlexRAN value)
{
...
static Is16vec16FlexRAN UpdateScheduleNorm(Is16vec16FlexRAN scheduleNorm, Is16vec16FlexRAN vnIn, Is16vec16FlexRAN deltaSigned)
{
  Is16vec16FlexRAN normSignProduct = _mm256_xor_si256(vnIn, deltaSigned);
  Is16vec16FlexRAN normPlusMinus = _mm256_sign_epi16(_mm256_set1_epi16(1), normSignProduct);
...
static Is16vec16FlexRAN SelectEqWorkaround(Is16vec16FlexRAN a, Is16vec16FlexRAN b, Is16vec16FlexRAN c, Is16vec16FlexRAN d)
{
