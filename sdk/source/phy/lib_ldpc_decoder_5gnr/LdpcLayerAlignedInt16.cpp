...
template<>
struct GetParityType<Is16vec16FlexRAN> { using type = int16_t; };
template<>
...
/// SIMD type (e.g., an Is16vec16FlexRAN would have an int16_t).
...
template void
SimdLdpc::LdpcAlignedRestore<Is16vec16FlexRAN>(LayerParamsInt16& request, DecoderResponseInt16& response);

template void
SimdLdpc::LdpcAlignedRestore<Is16vec32>(LayerParamsInt16& request, DecoderResponseInt16& response);

template void
SimdLdpc::LdpcLayerAlignedInt16<Is16vec16FlexRAN>(LayerParamsInt16& request, LayerOutputsInt16& response);
