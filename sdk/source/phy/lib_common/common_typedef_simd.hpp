...
/*!
 * \brief Class definition of type I16vec16FlexRAN
 * Defined here as this is not yet supported in dvec.h
 */
class I16vec16FlexRAN
{
public:
    static constexpr unsigned k_numElements = 16;

    I16vec16FlexRAN() { simd = _mm256_setzero_si256(); }

    //! Simple copy constructor.
    I16vec16FlexRAN(__m256i v) : simd(v) { }
    ...
    I16vec16FlexRAN(short value)
    {
      simd = _mm256_set1_epi16(value);
    }

    //! Set the first 16 values
    I16vec16FlexRAN(short src0, short src1, short src2, short src3,
    ...
    I16vec16FlexRAN operator-() const {
      I16vec16FlexRAN result;
      result.set_zero();
      result -= *this;
      return result;
    }

    friend I16vec16FlexRAN operator+ (const I16vec16FlexRAN &a, const I16vec16FlexRAN &b)
    {
        return (I16vec16FlexRAN)_mm256_add_epi16(a, b);
    }

    friend I16vec16FlexRAN operator- (const I16vec16FlexRAN &a, const I16vec16FlexRAN &b)
    {
      return (I16vec16FlexRAN)_mm256_sub_epi16(a, b);
    }

    friend I16vec16FlexRAN operator* (const I16vec16FlexRAN &a, const I16vec16FlexRAN &b)
    {
      return (I16vec16FlexRAN)_mm256_mullo_epi16(a, b);
    }

    friend I16vec16FlexRAN operator>> (const I16vec16FlexRAN &a, int count)
    {
      return (I16vec16FlexRAN)_mm256_srli_epi16(a, count);
    }

    friend I16vec16FlexRAN operator<< (const I16vec16FlexRAN &a, int count)
    {
      return (I16vec16FlexRAN)_mm256_slli_epi16(a, count);
    }

    I16vec16FlexRAN& operator -= (const I16vec16FlexRAN& rhs)
    {
      simd = _mm256_sub_epi16(simd, rhs.simd);
      return *this;
    }

    I16vec16FlexRAN& operator += (I16vec16FlexRAN rhs)
    {
...
/*!
 * \brief Class definition of type I32vec8FlexRAN
 * Defined here as this is not yet supported in dvec.h
 */
class I32vec8FlexRAN
{
public:

  static constexpr unsigned k_numElements = 32;

  I32vec8FlexRAN() { simd = _mm256_setzero_si256(); }

  //! Simple copy constructor.
  I32vec8FlexRAN(__m256i v) : simd(v) { }

  //! Allow implicit conversion to the underlying type.
  operator __m256i() const { return simd; }

  // Basic broadcast of scalar value.
  I32vec8FlexRAN(int value)
  {
    simd = _mm256_set1_epi32(value);
  }

  friend I32vec8FlexRAN operator +(const I32vec8FlexRAN &a, const I32vec8FlexRAN &b)
  {
      return (I32vec8FlexRAN)_mm256_add_epi32(a, b);
  }

  I32vec8FlexRAN& operator += (I32vec8FlexRAN rhs)
  {
...
/*!
 * \brief Class definition of type I8vec32FlexRAN
 * Defined here as this is not yet supported in dvec.h
 */
class I8vec32FlexRAN
{
public:

  static constexpr unsigned k_numElements = 32;

  I8vec32FlexRAN() { simd = _mm256_setzero_si256(); }

  //! Simple copy constructor.
  I8vec32FlexRAN(__m256i v) : simd(v) { }

  //! Allow implicit conversion to the underlying type.
  operator __m256i() const { return simd; }

  //! Set the first 32 values
  I8vec32FlexRAN(char src0, char src1, char src2, char src3, char src4, char src5, char src6, char src7,
